...
const contactMethods = [
  {
    name: 'Email',
    value: 'hello@courtneybuck.com',
    href: 'mailto:hello@courtneybuck.com',
    icon: (
  ...
  {
    name: 'LinkedIn',
    value: 'linkedin.com/in/courtneybuck',
      ...
      <div className="container-max">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 p-6 rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors resize-none"
