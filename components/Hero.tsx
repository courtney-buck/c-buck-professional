        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              View Work
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border-2 border-neutral-300 hover:border-neutral-400 dark:border-neutral-600 dark:hover:border-neutral-500 text-neutral-700 dark:text-neutral-300 font-medium rounded-lg transition-colors duration-200"
            >
              Get in Touch
            </motion.a>
          </motion.div>
